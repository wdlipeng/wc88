...
<table width="680" border="0" align="left" cellpadding="0" cellspacing="0">
		...
		<tr>
		  ...
		  <td><input name="captcha" type="text" id="captcha" size="6" maxlength="4" style="width:100px;" class="ddinput"/>&nbsp;&nbsp;<?=yzm()?></td>
		  <td id="ckyzm"><label class="field_notice">请填写验证码</label><label id="checking_captcha" class="checking">检查中...</label></td>
		</tr>
		<tr>
		  <td height="55" align="right" >手机验证码 *&nbsp;&nbsp;</td>
		  <td><input name="smscode" type="text" id="smscode" size="6" maxlength="5" style="width:100px;" class="ddinput"/>&nbsp;&nbsp;<button  onclick="sendsms('btnregscode','mobile','rc_uname','imgcode')" id="btnregscode" name="btnregscode" type="button" class="btn-sms btn-click-code btn-disabled">点击获取</button></td>
		  <td id="ckyzm"><label class="field_notice">请填写验证码</label><label id="checking_smscode" class="checking">检查中...</label></td>
		</tr>
		...
		<tr>
		  <td height="55">&nbsp;</td>
		  <td colspan="2"><div style=""><input name="agree" id="agree" type="checkbox" value="checkbox" checked="checked" /><span>我已阅读并同意物筹巴巴<a href="#" target="_blank" style="color: #e43737;text-decoration: none;font-size: 14px;">《使用协议》</a>及<a href="#" target="_blank" style="color: #e43737;text-decoration: none;font-size: 14px;">《隐私条款》</a></span></div></td>
	    </tr>
		<tr>
		  <td height="55">&nbsp;</td>
      ...
      <p>1、所有提供的所有商品</p>
      <p>2、本站不涉及网络支付等问题，所有商品购买最终都通过各大理财平台，故不存在账号泄露等问题，请买家放心。</p>
    ...
    $('#register_form').validate({
        ...
        rules : {
            ...
            smscode : {
                ...
                rangelength:[5,5],
				remote   : {
                    url :'index.php?mod=ajax&act=check_smscode',
                    type:'post',
                    data:{
                        smscode : function(){
                            return $('#smscode').val();
