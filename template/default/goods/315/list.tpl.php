...
<div class="list-good">
<div class="left">
<a href="<?=$row['url']?>" class="click_url" dd-href="?mod=jump&act=s8&iid=<?=iid_encode($row['data_id'])?>&url=" data-itemid="<?=$row['data_id']?>" isconvert=1 target="_blank"><?=dd_html_img($row['img'],$row['title'],310)?>
...
<div class="tp_ab">
    ...
    <div class="tp_bq tp_2 erweima dd_cure click_url" dd-href="?mod=jump&act=s8&iid=<?=iid_encode($row['data_id'])?>&url=" data-itemid="<?=$row['data_id']?>" isconvert=1 id="<?=$row['id']?>&uid=<?=$dduser['id']?>" url="<?=$row['url']?>" youhui="<?=$row['shouji_price_cha']?>">
...
<div class="opca"></div>
<?php }?><?php */?>
<a href="<?=$row['url']?>" class="click_url" dd-href="?mod=jump&act=s8&iid=<?=iid_encode($row['data_id'])?>&url=" data-itemid="<?=$row['data_id']?>" isconvert=1 target="_blank"><div class="jy_title"><?=$row['title']?></div></a>
<div class="jy_nr">
<div class="jy_price">
	<div class="inblock">
