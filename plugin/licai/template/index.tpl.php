...
<div class="mainbody" style="position:relative">
  ...
  <div class="iframe">
  <?php /*?> <iframe src="http://www.fanlicheng.com/plugin/licai/index.html?mid=<?=$dduser['id']?>&url=<?=urlencode(SITEURL)?>&cururl=<?=urlencode(p(MOD,ACT))?>" style='width:100%;height:1780px;' scrolling="no" frameborder='no' border='0'></iframe>  <?php */?>
