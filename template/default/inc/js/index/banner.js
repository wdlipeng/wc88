	...
	$.fn.lubo=function(options){
		...
		//生成左右按钮
			...
			function Btn(){
				...
				_btn.append('<div class="left_btn"><i class="icon-angle-left"></i></div><div class="right_btn"><i class="icon-angle-right"></i></div>');
		...
		// 
			var hover_box=jQuery(_lubo);
			hover_box.hover(function(){
				jQuery('.lubo_btn').fadeIn(300);
			},function(){
				jQuery('.lubo_btn').fadeOut(300);
			});
		//鼠标划过圆点 切换图片
